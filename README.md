...
author: jackwener
version: "0.6.4"
tags: "xiaohongshu, xhs, redbook, 小红书, social-media, cli"
---
...
If AUTH_OK, skip to Command Reference(在新标签页打开). If AUTH_NEEDED, proceed to Step 1. Prefer --qrcode when browser cookie extraction is unavailable but launching a browser is acceptable.

Step 1: Guide user to authenticate
Ensure user is logged into xiaohongshu.com in any browser supported by browser_cookie3(在新标签页打开). Supported browsers: Chrome, Arc, Edge, Firefox, Safari, Brave, Chromium, Opera, Opera GX, Vivaldi, LibreWolf, Lynx, w3m. Then:
...
Agent Defaults
All machine-readable output uses the envelope documented in SCHEMA.md(在新标签页打开). Payloads live under .data.
